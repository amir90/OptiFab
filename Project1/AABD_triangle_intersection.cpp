...
/*======================== X-tests ========================*/
 ...
 bool axisTestX01(float a, float b, float fa, float fb, const glm::vec3 &v0,
 ...
 bool axisTestX2(float a, float b, float fa, float fb, const glm::vec3 &v0,
...
/*======================== Y-tests ========================*/
 ...
 bool axisTestY02(float a, float b, float fa, float fb, const glm::vec3 &v0,
	const glm::vec3 &v2, const glm::vec3 &boxhalfsize, float &rad, float &min,
	float &max, float &p0, float &p2) {
	p0 = -a * v0.x + b * v0.z;
	p2 = -a * v2.x + b * v2.z;
 ...
 bool axisTestY1(float a, float b, float fa, float fb, const glm::vec3 &v0,
	const glm::vec3 &v1, const glm::vec3 &boxhalfsize, float &rad, float &min,
	float &max, float &p0, float &p1) {
	p0 = -a * v0.x + b * v0.z;
	p1 = -a * v1.x + b * v1.z;
...
/*======================== Z-tests ========================*/
 bool axisTestZ12(float a, float b, float fa, float fb, const glm::vec3 &v1,
	const glm::vec3 &v2, const glm::vec3 &boxhalfsize, float &rad, float &min,
 ...
 bool axisTestZ0(float a, float b, float fa, float fb, const glm::vec3 &v0,
	const glm::vec3 &v1, const glm::vec3 &boxhalfsize, float &rad, float &min,
	float &max, float &p0, float &p1) {
	p0 = a * v0.x - b * v0.y;
	p1 = a * v1.x - b * v1.y;
